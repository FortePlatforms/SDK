...
class CreateSubscriptionPreviewResponse(BaseModel):
    """
    ...
    interval: StrictStr
    next_renewal_at: datetime = Field(alias="nextRenewalAt")
    stripe_tax_calculation_id: Optional[StrictStr] = Field(default=None, alias="stripeTaxCalculationId")
    __properties: ClassVar[List[str]] = ["subtotalCents", "taxCents", "amountCents", "currency", "lineItems", "customerAddress", "interval", "nextRenewalAt", "stripeTaxCalculationId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSubscriptionPreviewResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSubscriptionPreviewResponse from a dict"""
        if obj is None:
            return None
