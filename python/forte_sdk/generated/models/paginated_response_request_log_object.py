...
class PaginatedResponseRequestLogObject(BaseModel):
    """
    PaginatedResponseRequestLogObject
    """ # noqa: E501
    items: List[RequestLogObject]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaginatedResponseRequestLogObject from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaginatedResponseRequestLogObject from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [RequestLogObject.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
