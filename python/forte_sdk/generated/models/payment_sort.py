...
class PaymentSort(BaseModel):
    ...
    def sort_by_validate_enum(cls, value):
        ...
        if value not in set(['CREATED_AT', 'AMOUNT_CENTS']):
            raise ValueError("must be one of enum values ('CREATED_AT', 'AMOUNT_CENTS')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentSort from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentSort from a dict"""
        if obj is None:
            return None
