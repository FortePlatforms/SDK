...
class ListUserInvitesResponse(BaseModel):
    """
    ListUserInvitesResponse
    """ # noqa: E501
    invites: Optional[List[PendingUserInviteObject]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListUserInvitesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListUserInvitesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "invites": [PendingUserInviteObject.from_dict(_item) for _item in obj["invites"]] if obj.get("invites") is not None else None
        })
        return _obj
