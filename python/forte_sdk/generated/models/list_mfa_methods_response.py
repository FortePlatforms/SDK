...
class ListMfaMethodsResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListMfaMethodsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListMfaMethodsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "methods": [MfaMethod.from_dict(_item) for _item in obj["methods"]] if obj.get("methods") is not None else None
        })
        return _obj
