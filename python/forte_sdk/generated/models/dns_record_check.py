...
class DnsRecordCheck(BaseModel):
    ...
    DnsRecordCheck
    """ # noqa: E501
    requirement: Optional[DnsRecordRequirement] = None
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['VERIFIED', 'MISSING', 'MISMATCH', 'RECOMMENDED_MISSING', 'LOOKUP_FAILED']):
            raise ValueError("must be one of enum values ('VERIFIED', 'MISSING', 'MISMATCH', 'RECOMMENDED_MISSING', 'LOOKUP_FAILED')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DnsRecordCheck from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DnsRecordCheck from a dict"""
        if obj is None:
            return None
