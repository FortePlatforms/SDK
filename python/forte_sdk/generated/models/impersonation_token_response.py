...
class ImpersonationTokenResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sessionToken", "expirationTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImpersonationTokenResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImpersonationTokenResponse from a dict"""
        if obj is None:
            return None
