...
class CreatePaymentPreviewRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["currency", "lineItems", "customerAddress", "shippingAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatePaymentPreviewRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatePaymentPreviewRequest from a dict"""
        if obj is None:
            return None
