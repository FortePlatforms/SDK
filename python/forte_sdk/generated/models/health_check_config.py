...
class HealthCheckConfig(BaseModel):
    ...
    healthy_threshold: Optional[StrictInt] = Field(default=None, alias="healthyThreshold")
    unhealthy_threshold: Optional[StrictInt] = Field(default=None, alias="unhealthyThreshold")
    protocol: Optional[StrictStr] = None
    path: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["interval", "timeout", "healthyThreshold", "unhealthyThreshold", "protocol", "path"]
