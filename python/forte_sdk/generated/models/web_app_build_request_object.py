...
class WebAppBuildRequestObject(BaseModel):
    """
    WebAppBuildRequestObject
    """ # noqa: E501
    build_id: Optional[StrictStr] = Field(default=None, alias="buildId")
    detection_error: Optional[WebAppDetectionError] = Field(default=None, alias="detectionError")
    ...
    origin_detail: Optional[StrictStr] = Field(default=None, alias="originDetail")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAppBuildRequestObject from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAppBuildRequestObject from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "detectionError": WebAppDetectionError.from_dict(obj["detectionError"]) if obj.get("detectionError") is not None else None,
            ...
            "originDetail": obj.get("originDetail"),
