...
class CreateManagedDatabaseRequest(BaseModel):
    """
    ...
    storage_gb: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, alias="storageGb")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateManagedDatabaseRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateManagedDatabaseRequest from a dict"""
        if obj is None:
            return None
