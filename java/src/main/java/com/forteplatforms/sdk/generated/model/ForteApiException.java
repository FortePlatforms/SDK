...
public class ForteApiException {
  ...
  public enum ErrorCodeEnum {
    ...
    PATH_BLOCKED(String.valueOf("PATH_BLOCKED")),
    ...
    MANAGED_DATABASE_ACCESS_REQUIRED(String.valueOf("MANAGED_DATABASE_ACCESS_REQUIRED")),
    
    MANAGED_DATABASE_QUOTA_EXCEEDED(String.valueOf("MANAGED_DATABASE_QUOTA_EXCEEDED")),
    
    MANAGED_DATABASE_NAME_TAKEN_IN_PROJECT(String.valueOf("MANAGED_DATABASE_NAME_TAKEN_IN_PROJECT")),
    
    MANAGED_DATABASE_NOT_FOUND(String.valueOf("MANAGED_DATABASE_NOT_FOUND")),
    
    MANAGED_DATABASE_TYPE_NOT_AVAILABLE(String.valueOf("MANAGED_DATABASE_TYPE_NOT_AVAILABLE")),
    
    MANAGED_DATABASE_TYPE_ACCESS_REQUIRED(String.valueOf("MANAGED_DATABASE_TYPE_ACCESS_REQUIRED")),
    
    MANAGED_DATABASE_DEDICATED_TIER_REQUIRES_SUPPORT(String.valueOf("MANAGED_DATABASE_DEDICATED_TIER_REQUIRES_SUPPORT")),
    
    MANAGED_DATABASE_USER_QUOTA_EXCEEDED(String.valueOf("MANAGED_DATABASE_USER_QUOTA_EXCEEDED")),
    
    MANAGED_DATABASE_USERNAME_TAKEN(String.valueOf("MANAGED_DATABASE_USERNAME_TAKEN")),
    
    MANAGED_DATABASE_USERNAME_RESERVED(String.valueOf("MANAGED_DATABASE_USERNAME_RESERVED")),
    
    MANAGED_DATABASE_USER_NOT_FOUND(String.valueOf("MANAGED_DATABASE_USER_NOT_FOUND")),
    
    MANAGED_DATABASE_CONNECTION_ALREADY_EXISTS(String.valueOf("MANAGED_DATABASE_CONNECTION_ALREADY_EXISTS")),
    
    MANAGED_DATABASE_CONNECTION_NOT_FOUND(String.valueOf("MANAGED_DATABASE_CONNECTION_NOT_FOUND")),
    
    MANAGED_DATABASE_CONNECTION_QUOTA_EXCEEDED(String.valueOf("MANAGED_DATABASE_CONNECTION_QUOTA_EXCEEDED")),
    
    MANAGED_DATABASE_CONNECTION_SERVICE_NOT_FOUND(String.valueOf("MANAGED_DATABASE_CONNECTION_SERVICE_NOT_FOUND")),
    
    MANAGED_DATABASE_CONNECTION_ENV_VAR_CONFLICT(String.valueOf("MANAGED_DATABASE_CONNECTION_ENV_VAR_CONFLICT")),
    
    MANAGED_DATABASE_ENV_VAR_MAPPING_REQUIRED(String.valueOf("MANAGED_DATABASE_ENV_VAR_MAPPING_REQUIRED")),
    
    MANAGED_DATABASE_CONNECTION_TEMPLATE_REQUIRED(String.valueOf("MANAGED_DATABASE_CONNECTION_TEMPLATE_REQUIRED")),
    
    MANAGED_DATABASE_CONNECTION_FORMAT_NOT_SUPPORTED(String.valueOf("MANAGED_DATABASE_CONNECTION_FORMAT_NOT_SUPPORTED")),
    
    MANAGED_DATABASE_HAS_ACTIVE_CONNECTIONS(String.valueOf("MANAGED_DATABASE_HAS_ACTIVE_CONNECTIONS")),
    
    MANAGED_DATABASE_NOT_READY(String.valueOf("MANAGED_DATABASE_NOT_READY")),
    
    MANAGED_DATABASE_STORAGE_BELOW_USAGE(String.valueOf("MANAGED_DATABASE_STORAGE_BELOW_USAGE")),
    
    MANAGED_DATABASE_STORAGE_LIMIT_EXCEEDED(String.valueOf("MANAGED_DATABASE_STORAGE_LIMIT_EXCEEDED")),
    
    MANAGED_DATABASE_USERNAME_TOO_LONG(String.valueOf("MANAGED_DATABASE_USERNAME_TOO_LONG")),
    
    MANAGED_DATABASE_AGENT_COMMAND_FAILED(String.valueOf("MANAGED_DATABASE_AGENT_COMMAND_FAILED")),
    
    MANAGED_DATABASE_CLUSTER_ALREADY_EXISTS(String.valueOf("MANAGED_DATABASE_CLUSTER_ALREADY_EXISTS")),
    
    MANAGED_DATABASE_CLUSTER_DISCOVERY_FAILED(String.valueOf("MANAGED_DATABASE_CLUSTER_DISCOVERY_FAILED")),
    
    MANAGED_DATABASE_CLUSTER_INSTANCE_NOT_FOUND(String.valueOf("MANAGED_DATABASE_CLUSTER_INSTANCE_NOT_FOUND")),
    
    MANAGED_DATABASE_CLUSTER_PROVISIONING_IN_PROGRESS(String.valueOf("MANAGED_DATABASE_CLUSTER_PROVISIONING_IN_PROGRESS")),
    
    MANAGED_DATABASE_CLUSTER_HAS_TENANTS(String.valueOf("MANAGED_DATABASE_CLUSTER_HAS_TENANTS")),
    ...
    GITHUB_REPOSITORY_NOT_ACCESSIBLE(String.valueOf("GITHUB_REPOSITORY_NOT_ACCESSIBLE")),
    
    GITHUB_BRANCH_NOT_FOUND(String.valueOf("GITHUB_BRANCH_NOT_FOUND")),
    ...
    USER_VERIFICATION_REQUIRED(String.valueOf("USER_VERIFICATION_REQUIRED")),
    ...
    GOOGLE_IDENTITY_ALREADY_LINKED(String.valueOf("GOOGLE_IDENTITY_ALREADY_LINKED")),
    
    INVALID_GOOGLE_CREDENTIAL(String.valueOf("INVALID_GOOGLE_CREDENTIAL")),
    ...
    SUPPORT_ATTACHMENT_INVALID_TYPE(String.valueOf("SUPPORT_ATTACHMENT_INVALID_TYPE")),
    
    SUPPORT_ATTACHMENT_LIMIT_EXCEEDED(String.valueOf("SUPPORT_ATTACHMENT_LIMIT_EXCEEDED")),
    ...
    ACCOUNT_BILLING_SUSPENDED(String.valueOf("ACCOUNT_BILLING_SUSPENDED")),
    
    NO_PENDING_EMAIL_VERIFICATION(String.valueOf("NO_PENDING_EMAIL_VERIFICATION")),
    
    ACCOUNT_HAS_NO_VERIFIED_EMAIL(String.valueOf("ACCOUNT_HAS_NO_VERIFIED_EMAIL")),
    
    ACCOUNT_OWNS_RESOURCES(String.valueOf("ACCOUNT_OWNS_RESOURCES")),
    ...
    SMS_OPT_IN_SCREENSHOT_INVALID(String.valueOf("SMS_OPT_IN_SCREENSHOT_INVALID")),
    ...
    PAYMENT_TRIGGER_NOT_ENABLED(String.valueOf("PAYMENT_TRIGGER_NOT_ENABLED")),
    
    PAYMENT_TRIGGER_INVOCATION_NOT_REPLAYABLE(String.valueOf("PAYMENT_TRIGGER_INVOCATION_NOT_REPLAYABLE")),
    ...
    EMAIL_RECIPIENT_SUPPRESSED(String.valueOf("EMAIL_RECIPIENT_SUPPRESSED")),
    
    EMAIL_SUPPRESSION_NOT_FOUND(String.valueOf("EMAIL_SUPPRESSION_NOT_FOUND")),
    
    EMAIL_SUPPRESSION_ALREADY_EXISTS(String.valueOf("EMAIL_SUPPRESSION_ALREADY_EXISTS")),
    ...
    CUSTOM_EMAIL_TEMPLATE_NOT_FOUND(String.valueOf("CUSTOM_EMAIL_TEMPLATE_NOT_FOUND")),
    
    CUSTOM_EMAIL_TEMPLATE_NAME_TAKEN_IN_PROJECT(String.valueOf("CUSTOM_EMAIL_TEMPLATE_NAME_TAKEN_IN_PROJECT")),
    
    CUSTOM_EMAIL_TEMPLATE_INVALID(String.valueOf("CUSTOM_EMAIL_TEMPLATE_INVALID")),
    
    CUSTOM_EMAIL_TEMPLATE_NAME_RESERVED(String.valueOf("CUSTOM_EMAIL_TEMPLATE_NAME_RESERVED")),
    
    CUSTOM_EMAIL_TEMPLATE_PARAMS_INVALID(String.valueOf("CUSTOM_EMAIL_TEMPLATE_PARAMS_INVALID")),
    
    RESERVED_EMAIL_TEMPLATE_NOT_SUPPORTED(String.valueOf("RESERVED_EMAIL_TEMPLATE_NOT_SUPPORTED")),
    ...
    MFA_CONFIG_INVALID(String.valueOf("MFA_CONFIG_INVALID")),
    ...
    MFA_PRIMARY_METHOD_REQUIRED(String.valueOf("MFA_PRIMARY_METHOD_REQUIRED")),
    ...
    REAUTHENTICATION_FACTOR_NOT_AVAILABLE(String.valueOf("REAUTHENTICATION_FACTOR_NOT_AVAILABLE")),
    
    REAUTHENTICATION_INVALID_CREDENTIAL(String.valueOf("REAUTHENTICATION_INVALID_CREDENTIAL")),
    
    REAUTHENTICATION_CODE_EXPIRED(String.valueOf("REAUTHENTICATION_CODE_EXPIRED")),
    
    REAUTHENTICATION_NO_ACTIVE_CHALLENGE(String.valueOf("REAUTHENTICATION_NO_ACTIVE_CHALLENGE")),
    
    REAUTHENTICATION_RATE_LIMITED(String.valueOf("REAUTHENTICATION_RATE_LIMITED")),
    ...
    DNS_HOSTING_NOT_ENABLED(String.valueOf("DNS_HOSTING_NOT_ENABLED")),
    ...
    DNS_ZONE_OVERLAPS_OWN_ZONE(String.valueOf("DNS_ZONE_OVERLAPS_OWN_ZONE")),
    
    DNS_ZONE_MERGE_NOT_READY(String.valueOf("DNS_ZONE_MERGE_NOT_READY")),
    
    DNS_ZONE_PARENT_STILL_DELEGATED(String.valueOf("DNS_ZONE_PARENT_STILL_DELEGATED")),
    
    DNS_ZONE_DELEGATION_CHECK_FAILED(String.valueOf("DNS_ZONE_DELEGATION_CHECK_FAILED")),
    
    DNS_ZONE_DELETING(String.valueOf("DNS_ZONE_DELETING")),
    
    DNS_ZONE_INVALID_DOMAIN(String.valueOf("DNS_ZONE_INVALID_DOMAIN")),
    
    DNS_ZONE_RESERVED_SUFFIX(String.valueOf("DNS_ZONE_RESERVED_SUFFIX")),
    
    DNS_ZONE_NOT_ACTIVE(String.valueOf("DNS_ZONE_NOT_ACTIVE")),
    
    DNS_RECORD_NOT_FOUND(String.valueOf("DNS_RECORD_NOT_FOUND")),
    
    DNS_RECORD_MANAGED(String.valueOf("DNS_RECORD_MANAGED")),
    
    DNS_RECORD_INVALID(String.valueOf("DNS_RECORD_INVALID")),
    ...
    DOMAIN_REGISTRATION_NOT_FOUND(String.valueOf("DOMAIN_REGISTRATION_NOT_FOUND")),
    
    DOMAIN_CONTACT_NOT_FOUND(String.valueOf("DOMAIN_CONTACT_NOT_FOUND")),
    
    DOMAIN_CONTACT_INVALID(String.valueOf("DOMAIN_CONTACT_INVALID")),
    
    DOMAIN_CONTACT_IN_USE(String.valueOf("DOMAIN_CONTACT_IN_USE")),
    
    DOMAIN_NOT_PURCHASABLE(String.valueOf("DOMAIN_NOT_PURCHASABLE")),
    
    DOMAIN_PRICE_CHANGED(String.valueOf("DOMAIN_PRICE_CHANGED")),
    
    DOMAIN_REGISTRATION_QUOTA_EXCEEDED(String.valueOf("DOMAIN_REGISTRATION_QUOTA_EXCEEDED")),
    
    DOMAIN_REGISTRATION_INVALID_STATE(String.valueOf("DOMAIN_REGISTRATION_INVALID_STATE")),
    
    DOMAIN_TERMS_NOT_ACCEPTED(String.valueOf("DOMAIN_TERMS_NOT_ACCEPTED")),
    
    DOMAIN_TRANSFER_LOCKED(String.valueOf("DOMAIN_TRANSFER_LOCKED")),
    
    DOMAIN_ALREADY_BEING_REGISTERED(String.valueOf("DOMAIN_ALREADY_BEING_REGISTERED")),
    
    DOMAIN_PAYMENT_SETUP_FAILED(String.valueOf("DOMAIN_PAYMENT_SETUP_FAILED")),
    ...
    OPS_SUGGESTION_INVALID_STATUS_TRANSITION(String.valueOf("OPS_SUGGESTION_INVALID_STATUS_TRANSITION")),
    ...
    IDEMPOTENCY_KEY_REUSED(String.valueOf("IDEMPOTENCY_KEY_REUSED")),
    
    IDEMPOTENT_REQUEST_IN_PROGRESS(String.valueOf("IDEMPOTENT_REQUEST_IN_PROGRESS"));
