 ...
 */
@JsonPropertyOrder({
  LoginUserResponse.JSON_PROPERTY_USER_ID,
...
public class LoginUserResponse {
  ...
  public LoginUserResponse userId(@javax.annotation.Nonnull String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public LoginUserResponse userObject(@javax.annotation.Nullable UserObject userObject) {
