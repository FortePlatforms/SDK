 ...
 */
@JsonPropertyOrder({
  ListContentResponse.JSON_PROPERTY_ITEMS,
  ListContentResponse.JSON_PROPERTY_NEXT_PAGE_TOKEN
})
...
public class ListContentResponse {
  ...
  public ListContentResponse items(@javax.annotation.Nonnull List<ContentObject> items) {
    this.items = items;
    return this;
  }

  public ListContentResponse addItemsItem(ContentObject itemsItem) {
    if (this.items == null) {
  ...
  public List<ContentObject> getItems() {
    return items;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ITEMS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(@javax.annotation.Nonnull List<ContentObject> items) {
    this.items = items;
  }
  ...
  /**
   * Return true if this ListContentResponse object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class ListContentResponse {\n");
